...
const { registerAccount, getAllAccounts, login, deleteAccountById, logout, updateById, updateAccount, getAccountAndLocation } = require('../controllers/account.controller');
