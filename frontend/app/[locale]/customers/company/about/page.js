    ...
    return (
        <main className='min-w-full'>
            <div className="relative pt-16 pb-32 flex content-center items-center justify-center min-h-screen-75">
                <div
                    className="absolute -top-5 w-full h-full bg-center bg-cover"
                    style={{
                        backgroundImage:
                            "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR5_P8IY1V7kLheCfvzb5HFXxD9pR9RubBYFw&s')",
                ...
                >
                    <span
                        id="blackOverlay"
                        className="w-full bg-black opacity-50 h-full absolute"
                    ></span>
                </div>
                ...
                <div className="container relative mx-auto">
                    <div className="flex flex-col items-center justify-center flex-wrap">
                        ...
                        <button
                            onClick={handleClick}
                            className="bg-white text-black hover:opacity-75 active:bg-blueGray-600  active:bg-opacity-100 text-sm font-bold uppercase px-6 md:px-20 py-3 rounded shadow hover:shadow-lg outline-none  focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                        >
                            Join Us
                        </button>
                    </div>
